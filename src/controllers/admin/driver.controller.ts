...
export const getDriverById = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
    const result = await driverService.getDriverById(String(id));
...
export const updateDriver = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
    const result = await driverService.updateDriver(id as string, req.body);
...
export const updateDriverStatus = async (req: Request, res: Response) => {
  try {
    ...
    const result = await driverService.updateDriverStatus(id as string, status);
