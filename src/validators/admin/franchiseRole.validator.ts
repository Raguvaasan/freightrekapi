...
export const franchiseModulePermissionSchema = yup.object({
  module: yup
    .string()
    .trim()
...
export const createFranchiseRoleSchema = yup.object({
  roleName: yup
    .string()
    .trim()
  ...
  permissions: yup
    .array()
    .of(franchiseModulePermissionSchema)
...
export const updateFranchiseRoleSchema = createFranchiseRoleSchema.shape({
  roleName: yup.string().min(2).max(50).optional(),
  permissions: yup.array().of(franchiseModulePermissionSchema).optional(),
