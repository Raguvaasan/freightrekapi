...
export const collectionAgencyModulePermissionSchema = yup.object({
  module: yup
    .string()
    .trim()
...
export const createCollectionAgencyRoleSchema = yup.object({
  roleName: yup
    .string()
    .trim()
  ...
  permissions: yup
    .array()
    .of(collectionAgencyModulePermissionSchema)
...
export const updateCollectionAgencyRoleSchema = createCollectionAgencyRoleSchema.shape({
  roleName: yup.string().min(2).max(50).optional(),
  permissions: yup.array().of(collectionAgencyModulePermissionSchema).optional(),
