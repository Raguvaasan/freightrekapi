...
import {
  ...
  getBookingCustomer,
} from '../../controllers/admin/bookingCustomer.controller';
import { authMiddleware } from '../../middleware/auth.middleware';
import { requireParcelRole, requireAdminPermission } from '../../middleware/parcelActor.middleware';
import { validate } from '../../middleware/validate.middleware';
import { bookingCustomerByMobileSchema } from '../../validators/admin/bookingCustomer.validator';
...
router.use(requireParcelRole('admin', 'agency'));
...
router.get(
  '/',
  requireAdminPermission(adminModule.parcel_management, 'read'),
  getAllBookingCustomers
);
...
router.get(
  '/:mobileNumber',
  requireAdminPermission(adminModule.parcel_management, 'read'),
  validate(bookingCustomerByMobileSchema),
  getBookingCustomer
);
