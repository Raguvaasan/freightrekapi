...
const getB2bVehicle = async (req, res) => {
    const result = await vehicle_service_1.b2bVehicleService.getById(req.params.id);
    return res.status(result.success ? 200 : 404).json(result);
};
exports.getB2bVehicle = getB2bVehicle;
const updateB2bVehicle = async (req, res) => res.json(await vehicle_service_1.b2bVehicleService.update(req.params.id, req.body));
exports.updateB2bVehicle = updateB2bVehicle;
const deactivateB2bVehicle = async (req, res) => res.json(await vehicle_service_1.b2bVehicleService.deactivate(req.params.id));
exports.deactivateB2bVehicle = deactivateB2bVehicle;
const deleteB2bVehicle = async (req, res) => res.json(await vehicle_service_1.b2bVehicleService.delete(req.params.id));
