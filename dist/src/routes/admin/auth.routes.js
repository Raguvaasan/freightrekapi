...
router.post("/create-user", auth_middleware_1.authMiddleware, (0, checkPermission_middleware_1.checkPermission)(adminModule_1.adminModule.access_management, 'write'), (0, validate_middleware_1.validate)(auth_validator_1.registerSchema), authController.register);
/**
 * @swagger
 * /admin/auth/login:
 *   post:
