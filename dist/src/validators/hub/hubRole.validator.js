...
exports.updateHubRoleSchema = exports.createHubRoleSchema = exports.hubModulePermissionSchema = void 0;
const yup = __importStar(require("yup"));
exports.hubModulePermissionSchema = yup.object({
    module: yup
        .string()
        .trim()
...
exports.createHubRoleSchema = yup.object({
    roleName: yup
        .string()
        .trim()
    ...
    permissions: yup
        .array()
        .of(exports.hubModulePermissionSchema)
...
exports.updateHubRoleSchema = exports.createHubRoleSchema.shape({
    roleName: yup.string().min(2).max(50).optional(),
    permissions: yup.array().of(exports.hubModulePermissionSchema).optional(),
