...
exports.updateRoleSchema = exports.createRoleSchema = exports.modulePermissionSchema = void 0;
const yup = __importStar(require("yup"));
exports.modulePermissionSchema = yup.object({
    module: yup
        .string()
        .trim()
...
exports.createRoleSchema = yup.object({
    roleName: yup
        .string()
        .trim()
    ...
    permissions: yup
        .array()
        .of(exports.modulePermissionSchema)
...
exports.updateRoleSchema = exports.createRoleSchema.shape({
    roleName: yup.string().min(2).optional(),
    permissions: yup.array().of(exports.modulePermissionSchema).optional(),
